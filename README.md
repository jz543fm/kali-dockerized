# Dockerized Kali Linux and Ubuntu 26.04
...
You can use multiple options to run Kali Linux in Docker or Kali Linux + Ubuntu 26.04 in Docker (docker run, docker build or docker-compose.yaml usage or by Makefile), examples are below:
